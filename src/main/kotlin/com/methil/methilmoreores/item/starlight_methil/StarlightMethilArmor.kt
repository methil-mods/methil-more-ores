...
object StarlightMethilArmor{
    ...
    val STARLIGHT_METHIL_ARMOR_MATERIAL = ARMOR_MATERIALS.register("starlight_methil_armor", Supplier {
        ArmorMaterial( // Determines the defense value of this armor material, depending on what armor piece it is.
            ...
            { Ingredient.of(StarlightMethilItem.STARLIGHT_METHIL_ITEM) },

            listOf(
                ArmorMaterial.Layer(
                    MethilMoreOres.location("starlight_methil")
                ),
            ),
            0f,
            0f
