...
class ModBlockLootTables(p_344943_: HolderLookup.Provider) :
    BlockLootSubProvider(setOf<Item>(), FeatureFlags.REGISTRY.allFlags(), p_344943_) {
    override fun generate() {
        add(MethilBlock.METHIL_ORE_BLOCK.get(), createOreDrop(MethilBlock.METHIL_ORE_BLOCK.get(), MethilItem.METHIL_ITEM.get()))
        dropSelf(MethilBlock.METHIL_ORE_BLOCK.get())
    }
